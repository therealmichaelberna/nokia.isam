...
"""
The isam_ont_slots config file.
...
class Ont_slots(ResourceModule):
    """
    The isam_ont_slots config class
    """

    def __init__(self, module):
        super(Ont_slots, self).__init__(
            empty_fact_val={},
            facts_module=Facts(module),
            module=module,
            resource="ont_slots",
            tmplt=Ont_slotsTemplate(),
        )
        self.parsers = [
        ]
    ...
    def _compare(self, want, have):
        """Leverages the base class `compare()` method and
           ...
           for the Ont_slots network resource.
        """
